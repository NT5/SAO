...
class Twig {
     ...
     * @example ./docs/examples/Modules/WebPage/Twig.md 2 2 Creacion del objeto Twig
     */
     ...
     * @example ./docs/examples/Modules/WebPage/Twig.md 7 9 Establecer archivo de plantilla
     */
     ...
     * @example ./docs/examples/Modules/WebPage/Twig.md 17 6 Establece un filtro nuevo
     */
     ...
     * @example ./docs/examples/Modules/WebPage/Twig.md 24 10 Añade variables
     */
     ...
     * @param array $vars
     * @example ./docs/examples/Modules/WebPage/Twig.md 35 9 Añade variables
     */
     ...
     * @see $Twig_Vars
     * @example ./docs/examples/Modules/WebPage/Twig.md 45 7 Retorna variable
     */
     ...
     * @see $Template_File
     * @see $Twig_Vars
     * @example ./docs/examples/Modules/WebPage/Twig.md 53 2 Muestra plantilla
     * @return string
     */
